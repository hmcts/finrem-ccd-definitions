...
export const  contestedCreatePaperChildrenCaseDetailsTable: Table = {
    ...
    rows: [
        ...
        {cellItem:'Address Line 2', value: 'Water Unite'},
        ...
        { cellItem: "Please choose the FRC which covers the area within which the Applicant resides.", value: 'Birmingham FRC'},
        { cellItem: "Where is the Applicant’s Local Court?", value: 'COVENTRY COMBINED COURT CENTRE'},
        { cellItem: 'Do you consider that the case should be allocated to be heard at High Court Judge level?', value: 'Yes'},
        { cellItem: 'Does anyone in this application need assistance or special facilities when attending court?',  value: 'Special facilities', rowType: 'label-value-adjacent' },
        { cellItem: 'Does anyone in this application need specific arrangements when attending court?', value: 'Special Arrangements', rowType: 'label-value-adjacent' },
        { cellItem: 'Are there any reasons why the case should not proceed in the applicant’s Local Court? If yes, please set out what they are.', value: 'Yes'},
        { cellItem: "Please specify", value: "FRC Reason" },
