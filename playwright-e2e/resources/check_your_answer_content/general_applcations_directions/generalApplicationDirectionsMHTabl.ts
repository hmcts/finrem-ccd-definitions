export const contestedGeneralApplicationDirectionsMHTableData = {
    tableName: 'Check your answers',
    rows: [
        { cellItem: "Is a Hearing required?", value: "Yes" },
        { cellItem: "Type of Hearing", value: "Application Hearing" },
        { cellItem: "Hearing Time Estimate", value: "3 hours" },
