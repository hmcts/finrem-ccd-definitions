...
export const adjournHearingNotRelistedTableData: Table = {
  tableName: 'Check your answers',
  rows: [
    'Adjourn or Vacate hearing',
    {cellItem: 'Adjourn or Vacate a hearing?', value: 'Adjourn hearing'},
...
export const adjournHearingRelistedTableData: Table = {
  tableName: 'Check your answers',
  rows: [
    'Adjourn or Vacate hearing',
    {cellItem: 'Adjourn or Vacate a hearing?', value: 'Adjourn hearing'},
