...
export const ISSUE_APPLICATION = (issueDate: string) => {return [
  { action: 'insert', key: 'issueDate', value: issueDate }
];};

export const DIRECTIONS_LIST_DATA = (codeForGeneralApplicationDirectionsEvent: string) => {return [
...
export const REFER_LIST_DATA = (generalApplicationId: string) => {return [
...
export const OUTCOME_LIST_DATA = (generalApplicationId: string) => {return [
