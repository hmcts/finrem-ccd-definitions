...
async function contestedCaseworkerCreatePaperCase(reference, applicationType, applicantRepresent) {
  const I = this;
  I.waitForPage('#applicantRepresentedLabel', 'Is the Applicant represented ?');
...
module.exports = { contestedCaseworkerCreate, contestedCaseworkerCreatePaperCase };