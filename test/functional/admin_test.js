Feature('Admin Web -- commented out these test cases as I dont think we should run these tests');

xScenario('add all the roles @pipeline', I => {
...
xScenario('upload Consented Config file @pipeline', I => {
  I.loginToAdminConsole();
...
xScenario('upload Contested Config file @pipeline', I => {
  I.loginToAdminConsole();
