...
Scenario('Contested Matrimonial Case Creation by Solicitor @nightly @preview', async ({ I }) => {
    await I.signInIdam(solicitorUserName, solicitorPassword);
    await I.wait('2');
...
//disable in preview
Scenario('Contested Matrimonial Case Creation by Caseworker MIAM No and Yes Exemption @nightly @preview', async ({ I }) => {
    I.signInIdam(caseWorkerUserName, caseWorkerPassword);
    I.wait('15');
    await I.createCase('FinancialRemedyContested', 'Form A Application');
    await I.contestedCaseworkerCreate(caRef, 'Matrimonial', true);
...
Scenario('Contested Matrimonial Case Creation by Caseworker MIAM No and No Exemption @nightly @preview', async ({ I }) => {
    I.signInIdam(caseWorkerUserName, caseWorkerPassword);
    I.wait('15');
    await I.createCase('FinancialRemedyContested', 'Form A Application');
    await I.contestedCaseworkerCreate(caRef, 'Matrimonial', true);
